...
NCS_radMixValues = []
"""
Variable used to hold the mixture values for the negative charge states when performing a radiative simulation
"""
PCS_augMixValues = []
"""
Variable used to hold the mixture values for the positive charge states when performing an auger simulation
"""
NCS_augMixValues = []
"""
...
xfinal = []
"""
Variable to hold the final x values calculated for the simulation
"""
#Loaded experimental spectrum x values
exp_x = []
"""
Variable to hold the loaded experimental x values
"""
#Loaded experimental spectrum y values
exp_y = []
"""
Variable to hold the loaded experimental y values
"""
#Loaded experimental spectrum y error values
exp_sigma = []
"""
Variable to hold the loaded experimental y error values
"""
...
labeldict = {'K1': '1s', 'L1': '2s', 'L2': '2p*', 'L3': '2p', 'M1': '3s', 'M2': '3p*', 'M3': '3p', 'M4': '3d*',
             ...
             'O9': '5g', 'P1': '6s'}
"""
Variable with the correspondence between Siegbahn notation and relativistic orbitals
"""
